...
This fork carries its patches on top of [`waybarrios/vllm-mlx@93b0b71`](https://github.com/waybarrios/vllm-mlx/commit/93b0b71) (2026-09-19, past `v0.5.0`; previous pins: `ec8e493` (2026-09-15), `22efb47` (2026-08-27), `4b654c0` (2026-08-23), `5021350` (2026-08-15, one commit past `v0.4.1`), `b998776`, `d96458c`, `0dd1157` (`v0.4.0`), `a48c86c`, `caa8838`, `015e080`, `395b13c`, `9c83c84`). Each patch is a separate commit on `main` with the prefix `patch:`. They are listed here in apply order (bottom of git log → top).
