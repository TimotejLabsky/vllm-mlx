...
def serve_command(args):
    ...
    if args.continuous_batching:
        ...
        scheduler_config = SchedulerConfig(
            ...
            # #95: --prefill-step-size was silently dropped on this path
            # (only the mllm variant was threaded) — upstream issue #729,
            # verified live: a 2048/4096/8192 sweep produced identical
            # prefill rates because every rung ran the 2048 default.
